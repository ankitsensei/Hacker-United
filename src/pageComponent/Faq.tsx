...
const Faq: React.FC = () => {
    const faqs: FAQ[] = [
        ...
        },
        {
            ...
            answer: "The workshop schedule is available in our Discord!",
        },
        {
        ...
        },
        {
            ...
            answer: "To register, start off by clicking 'Register' at the top of the website. After filling out that form, go to Devpost and sign up there! Also, don't forget to join our Discord.",
        },
        {
        ...
        {
            question: "What if I'm not interested in coding?",
            answer: "This hackathon is a space to get interested. As long as you like to solve problems, you are more than welcome to attend our hackathon to learn and connect with an encouraging community.",
        },
        {
        ...
        <div className="flex flex-col items-center mx-4">
            ...
            <div className="w-full lg:w-3/4">
                {faqs.map((faq, index) => (
                    <div
                        key={index}
                        className="border-b border-zinc-500 py-4"
                    >
                        <button
