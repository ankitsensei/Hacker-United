...
const Btn: React.FC<BtnProps> = ({ name, link, onClick }) => {
    return (
        <div onClick={onClick} className="group relative inline-block outline-none">
            <button className="relative overflow-hidden text-white bg-gradient-to-r from-pink-600 via-purple-600 to-zinc-900 border-2 border-pink-600 text-sm px-3 py-2 mt-5 rounded-md transition-transform duration-300 ease-in-out transform hover:scale-105 hover:shadow-lg">
